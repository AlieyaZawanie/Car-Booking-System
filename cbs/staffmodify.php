...
//SQL DELETE
$sql = "SELECT * FROM tb_vehicle WHERE v_reg = '$freg'";
...
<div class="container mt-4">
  <div class="row justify-content-center">
    <div class="col-sm-6">
      <br><br>
      <form method="POST" action="staffmodifyprocess.php">
        <fieldset>
          <legend class="text-center">Modify Form</legend><br>
          <br>
          <label for="exampleSelect1" class="text-center">Vehicle Registration Number: <?php echo $freg;?></label><br><br>

  <div class="form-group">
     <label for="exampleInputPrice" class="form-label mt-4">Price</label>
    <input type="text" name="fprice" class="form-control" id="exampleInputPrice" value="<?php echo $row['v_price']?>" >
  </div>


    <input type="hidden" name="fbid" value="<?php echo $row['v_reg']?>" >
