        ...
        <section class="py-4 py-xl-5">
            ...
            <div class="container py-4 py-xl-5">
                <div class="row gy-4 gy-md-0">
                    ...
                    <div class="col-md-6">
                        <div class="p-xl-5 m-xl-5"><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png" width="336" height="300" /></div>
                    </div>
                </div>
            </div>
        </section>
