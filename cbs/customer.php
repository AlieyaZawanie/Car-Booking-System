...
<div class="container my-5">
  <h3 class="text-center">WELCOME! <?php echo $row1['u_name']; ?> </h3>
  <div class="row">
    ...
    <div class="col-sm-6">
      <form method="POST" action="customerprocess.php" class="mx-auto" style="width: 80%;">
        <fieldset>
          <legend class="text-center">Booking Form</legend>
          ...
          <button type="reset" class="btn bg-danger mt-4">Clear Form</button>
      ...
      <!-- Validation script for checking return date is not earlier than pickup date -->
      <script>
...
<!-- Pass the booking status data to JavaScript -->
<script>
  var b_status = "<?php echo $b_status; ?>";
</script>
