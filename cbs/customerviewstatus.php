  ...
  <tbody>
      <?php
           while($row=mysqli_fetch_array($result))
           {
            ...
            echo "<td>";
                 echo "<a href='customercancel.php?id=".$row['b_id']."' class='btn btn-warning' onclick='return confirm(\"Are you sure you want to delete?\");'>Cancel</a>";
                echo "</td>";
