...
<body>
    <section class="py-4 py-xl-5">
        <div class="container">
            <div class="row mb-10">
                <div class="col-md-10 col-xl-6 text-center mx-auto">
                    <h2>Registration Form</h2>
                    <p>Welcome to our Car Renting Service !</p>
                </div>
            </div>
      ...
      <input type="text" name="femail" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your valid email" required>
    </div>

    <div class="form-group">
      <label for="exampleInputPassword1" class="form-label mt-4">IC Number</label>
      <input type="text" name="fic" class="form-control" id="exampleInputPassword1" placeholder="Enter your identification card number" required>
    </div><br>

  <div class="form-group">
    <label for="password">Password:</label>
    <input type="password" name="fpwd" class="form-control" id="newpwd" placeholder="Please create a strong password" required>
  ...
  <div class="form-group">
    <label for="exampleInputPassword2" class="form-label mt-4">Confirm Password</label>
     <input type="password" name="fcpwd" class="form-control" id="exampleInputPassword2" placeholder="Please confirm your password" required>
  </div>
    ...
    <div class="form-group">
      ...
      <textarea name="fadd" class="form-control" id="exampleTextarea" rows="3" placeholder="Enter your complete address" ></textarea >
    </div>

    <div class="form-group row">
      <label for="exampleInputEmail1" class="form-label mt-4">Contact Number</label>
      <input type="text" name="fcont" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your mobile number" required>
    </div>
...
<script>
    ...
    function validatePassword() {
      if (document.forms[0].fpwd.value != document.forms[0].fcpwd.value) {
