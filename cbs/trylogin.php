            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        <h2>Log in</h2>
                        <p>Hello! Welcome to Alie Car Rental Service!!! Please log into ypur account to enjoy our service! </p>
                    </div>
                </div>
                        ...
                        <div class="card mb-1">
                            ...
                            <div class="form-group">
                              ...
                              <input type="password" name="fpwd" class="form-control" id="exampleInputPassword1" placeholder="Enter your password" required>
                                    ...
                                    <br><div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit">Login</button></div>
