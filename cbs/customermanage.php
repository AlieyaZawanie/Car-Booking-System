  ...
  <tbody>
      <?php
           while($row=mysqli_fetch_array($result))
           {
            ...
            echo "<a href='javascript:void(0);' class='btn btn-warning' onclick='if(confirm(\"Are you sure you want to cancel this booking?\")) window.location.href = \"customercancel.php?id=".$row['b_id']."\";'>Cancel</a>";
        echo "</td>";
            echo '</tr>';
